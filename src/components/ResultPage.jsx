    ...
    <div className="result-page" style={{ position: 'relative', zIndex: 10 }}>
      ...
      >
        ...
        <img src="/logo.png" alt={COMPANY_NAME}
          style={{ height: 34, margin: '0 auto 20px', filter: 'brightness(0) invert(1)', opacity: 0.8 }}
        ...
        {/* Big WhatsApp CTA — first thing they see */}
        <a href={waLink} target="_blank" rel="noopener noreferrer" className="btn btn-whatsapp btn-whatsapp-hero">
          ...
          {t('📲 Book Your Free Trial on WhatsApp', '📲 احجز جلستك التجريبية على واتساب')}
        </a>
      </div>
